export function applyJourneyModifier(base, config = {}) {
  ...
  case 'low-visibility': result.fog = (base.fog || 1) * 1.65; break
  case 'star-trail': result.stars = (base.stars || 1) * 1.6; break
  case 'moving-formation': result.movingObstacles = true; break
  case 'shortcut-gates': result.shortcutGates = true; break
